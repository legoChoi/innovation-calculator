...
public enum PostProcessMenuCommand {
    ...
    PostProcessMenuCommand(String command, String index, String description) {
    ...
    public static PostProcessMenuCommand findByIndexOrCommand(String commandInput) {
